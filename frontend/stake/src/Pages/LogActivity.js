...
import { columnsAdmin, dataAdmin , dataUser , columnsUser} from '../Data/LogActivity'
            ...
            expandedRowRender: (record) => (
              ...
              >
                <p style={{
                  ...
                  {record.content ? 'User' : 'Admin'}:</b> <br/> {record.user_name}</p>
                <p style={{
                  width: '100%', // Matches the width of the table
                  whiteSpace: 'wrap',
                  boxSizing: 'border-box', // Ensures padding doesn't exceed total width
                }}> <b>
                  {record.content ? 'Content' : 'Activity'}:</b> <br/> {record.content ? record.content : record.activity}</p>
